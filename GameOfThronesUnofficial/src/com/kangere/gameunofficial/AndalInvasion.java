...
public class AndalInvasion extends Activity implements OnClickListener, AdListener {

	private RelativeLayout layout;
	private AdView mAdView;
	private AdManager mManager;
	Button andal, invasion;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.andal_invasion);
		layout = (RelativeLayout) findViewById(R.id.adsdkContent6);
		initAds();
		init();
	...
	private void init() {
		andal = (Button) findViewById(R.id.bAndals);
		invasion = (Button) findViewById(R.id.bInvasion);
		andal.setOnClickListener(this);
		invasion.setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		case R.id.bAndals:
			try {
				Class<?> cl = Class.forName("com.kangere.history.Andals");
		...
		case R.id.bInvasion:
			try {
				Class<?> cl = Class.forName("com.kangere.history.Invasion");
				Intent i = new Intent(this, cl);
				startActivity(i);
			} catch (ClassNotFoundException e) {
				// TODO Auto-generated catch block
	...
	public void adClicked() {
		Toast.makeText(AndalInvasion.this, "Ad clicked!", Toast.LENGTH_LONG)
		.show();
	...
	public void adClosed(Ad arg0, boolean arg1) {
		Toast.makeText(AndalInvasion.this, "Ad closed!", Toast.LENGTH_LONG)
		.show();
	...
	public void adShown(Ad arg0, boolean arg1) {
		Toast.makeText(AndalInvasion.this, "Ad shown!", Toast.LENGTH_LONG)
		.show();
